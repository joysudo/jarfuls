...
export const USERS: UserConfig[] = [
  {
    ...
    color: '#E2A33D',
    colorSoft: '#FBEBCB',
    mainQuest: 'idk what you want as a main quest lol. i set ur pointgoal at 1000',
    pointGoal: 1000,
    emoji: '🥜',
  },
  {
    ...
    color: '#C4477B',
    colorSoft: '#F7DCE7',
    mainQuest: 'Build a source of passive income that will return at least $5 in the next 10 years.',
    pointGoal: 1000,
    emoji: '🍓',
  },
];
